...
//    header("Location: http://www.example.com/");
    ...
    if (!getimagesize($_FILES['file_data']['tmp_name'])) {
        err(404,'File or Directory Not Found');
...
<style>
body {font-family: "lucida grande","Segoe UI",Arial, sans-serif; font-size: 14px;width:95%;padding:1em;margin:0;}
...
<?php
echo <<<EOD
<p style="background: yellow">You can upload only images.</p>
EOD;
?>
